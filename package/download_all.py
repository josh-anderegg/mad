...
CHANNELS = ["TCI_R", "TCI_G", "TCI_B", "B2", "B3", "B4", "B5", "B6", "B7", "B8", "B8A", "B9", "B11", "B12", "AOT"]
...
regions = gpd.read_file(BASE_DIR / "data/Ecoregions2017/Ecoregions2017.shp").to_crs(crs=3857)
...
def process_tile(tile):
    try:
        ...
        images = ee.imagecollection.ImageCollection("COPERNICUS/S2_SR_HARMONIZED")\
        ...
        for i in range(images.size().getInfo()):
            img_string = BASE_DIR / f'data/images/S2_{id_string}_{i}.tif'
